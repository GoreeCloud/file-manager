...
Current authoritative main `acbabdcb86eb5a9a1cdb907be613c5d0954a7447` integrates the validated Linux desktop Development stack from PRs #16–#19 while preserving Android-only `supported_platforms`. The active `platform/glaze-v1.4-contract-v0.3-20260914` candidate is based on that main revision, carries forward the still-unmerged exact-resource transfer hardening from PR #15, and advances current Stable GLAZE UI V1.4 / `1.4.0` plus corrected seven-system Platform Contract `0.3` source declarations. Exact head `9bda0b1a3599f41e6f72cd0648787c59fa86c1ad` passed Android foundation validation, Linux development validation, and corrected seven-system Platform Contract validation after `ARCHITECTURE.md` and `SPECIFICATIONS.md` were reconciled to the V1.4 Development state. This remains Development evidence only; rendered/native application acceptance, supported Linux product status, production, Release Candidate, and Stable qualification remain separate gates.
...
| FR-011 | Shared platform-neutral provider/resource/operation/evidence core with verified ordinary-file transfer semantics. | High | Validated development foundation on authoritative main; exact-resource identity and unknown-destination-size transfer verification from Draft PR #15 are carried forward on the active V1.4/Contract 0.3 candidate and pass exact-head Android/Linux source-build validation, but integration and product acceptance remain separate |
...
| FR-027 | Migrate File Manager source declarations and Android presentation mapping to current Stable GLAZE UI V1.4 / `1.4.0` and corrected seven-system Platform Contract `0.3` without manufacturing platform acceptance. | High | Source-migrated and exact-head source/build validated on the active candidate; GLAZE UI rendered/native/application acceptance, representative-platform evidence, review/integration, release, and production gates remain open |
